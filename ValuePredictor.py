...
class ValuePredictor(nn.Module):
    def __init__(self):
        ...
        self.lstm = nn.LSTM(input_size=Constants.LSTM_INPUT_SIZE, hidden_size=Constants.LSTM_HIDDEN_SIZE, num_layers=Constants.LSTM_NUM_LAYERS, bidirectional=False, batch_first=True)
